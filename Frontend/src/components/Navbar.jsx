...
//   const [labTitle, setLabTitle] = useState("FGC Lab");
...
//               className={({ isActive }) =>
//                 `transition duration-150 flex items-center whitespace-nowrap
//                  ${isMobile ? 'w-full text-left text-base' : 'text-sm'}
//                  ${isActive 
...
//             className={`text-gray-700 hover:text-brand-accent px-3 py-2 rounded-md font-medium transition duration-150 flex items-center whitespace-nowrap
//              ${isMobile ? 'w-full text-left text-base hover:bg-gray-100' : 'text-sm'}`}
//           >
//             {title}
//           </a>
//         </li>
...
//                     className="text-gray-700 hover:text-brand-accent px-3 py-2 rounded-md text-sm font-medium transition duration-150 flex items-center"
//                   >
...
//             <button
//               onClick={toggleMenu}
//               className="inline-flex items-center justify-center p-2 rounded-md text-brand-primary hover:text-brand-accent hover:bg-gray-100 focus:outline-none"
//             >
